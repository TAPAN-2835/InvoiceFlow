...
var appendOffsetOfLegend = (offset, legendSettings, legendSize) => {
	if (legendSettings && legendSize) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$37(_objectSpread$37({}, offset), {}, { [align]: offset[align] + (boxWidth || 0) });
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$37(_objectSpread$37({}, offset), {}, { [verticalAlign]: offset[verticalAlign] + (boxHeight || 0) });
	}
	return offset;
};
...
function getTooltipEntry(_ref4) {
	...
	return _objectSpread$37(_objectSpread$37({}, tooltipEntrySettings), {}, {
		dataKey,
		payload,
		value,
		name
...
var selectChartOffsetInternal = createSelector([
	...
	var offset = _objectSpread$36(_objectSpread$36({}, {
	...
	return _objectSpread$36(_objectSpread$36({ brushBottom }, offset), {}, {
...
var SizeDetectorContainer = /*#__PURE__*/ (0, import_react.forwardRef)((_ref2, ref) => {
	...
	return /*#__PURE__*/ import_react.createElement("div", {
		...
		style: _objectSpread$35(_objectSpread$35({}, style), {}, {
			width,
			height,
			minWidth,
			minHeight,
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent = () => {
		if (payload && payload.length) {
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				var finalItemStyle = _objectSpread$34(_objectSpread$34({}, defaultDefaultTooltipContentProps.itemStyle), {}, { color: entry.color || defaultDefaultTooltipContentProps.itemStyle.color }, itemStyle);
	...
	var finalStyle = _objectSpread$34(_objectSpread$34({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function TooltipBoundingBoxImpl(props) {
	...
	var outerStyle = _objectSpread$33(_objectSpread$33({}, props.hasPortalFromProps ? {} : _objectSpread$33(_objectSpread$33({ transition: resolveTransitionProperty({
...
var getPath$1 = (_ref) => {
	...
	if (Array.isArray(baseLine)) {
		var _lineFunction;
		var areaPoints = points.map((entry, index) => _objectSpread$32(_objectSpread$32({}, entry), {}, { base: baseLine[index] }));
...
var Cross = (_ref) => {
	var { x = 0, y = 0, top = 0, left = 0, width = 0, height = 0, className } = _ref, rest = _objectWithoutProperties$17(_ref, _excluded$17);
	var props = _objectSpread$31({
		x,
		y,
		top,
		left,
...
*/
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$30(_objectSpread$30({}, res), {}, { [key]: fn(key, obj[key]) }), {});
//#endregion
...
var calStepperVals = (easing, preVals, steps) => {
	var nextStepVals = mapObject((key, val) => {
		if (needContinue(val)) {
			...
			return _objectSpread$29(_objectSpread$29({}, val), {}, {
				from: newX,
				velocity: newV
			});
		}
	...
	if (steps < 1) return mapObject((key, val) => {
		if (needContinue(val) && nextStepVals[key] != null) return _objectSpread$29(_objectSpread$29({}, val), {}, {
...
function createStepperUpdate(from, to, easing, interKeys, render, timeoutController) {
	var preTime;
	var stepperStyle = interKeys.reduce((res, key) => _objectSpread$29(_objectSpread$29({}, res), {}, { [key]: {
		from: from[key],
		velocity: 0,
		to: to[key]
	} }), {});
	...
	var stepperUpdate = (now) => {
		...
		render(_objectSpread$29(_objectSpread$29(_objectSpread$29({}, from), to), getCurrStyle()));
		preTime = now;
...
function createTimingUpdate(from, to, easing, duration, interKeys, render, timeoutController) {
	...
	var timingStyle = interKeys.reduce((res, key) => {
		...
		return _objectSpread$29(_objectSpread$29({}, res), {}, { [key]: [fromElement, toElement] });
	}, {});
	var beginTime;
	var timingUpdate = (now) => {
		...
		render(_objectSpread$29(_objectSpread$29(_objectSpread$29({}, from), to), currStyle));
		if (t < 1) stopAnimation = timeoutController.setTimeout(timingUpdate);
			...
			render(_objectSpread$29(_objectSpread$29(_objectSpread$29({}, from), to), finalStyle));
		}
	};
	return () => {
...
var configUpdate_default = (from, to, easing, duration, render, timeoutController) => {
	...
	if (easing == null) return () => {
		render(_objectSpread$29(_objectSpread$29({}, from), to));
		return () => {};
	};
...
*/
var _excluded$16 = ["radius"], _excluded2$8 = ["radius"];
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		var _svgPropertiesAndEven = svgPropertiesAndEvents(props), { radius: _ } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$16(_svgPropertiesAndEven, _excluded$16);
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), { radius: _ } = _svgPropertiesAndEven2, otherPathProps = _objectWithoutProperties$16(_svgPropertiesAndEven2, _excluded2$8);
		return /*#__PURE__*/ import_react.createElement("path", _extends$18({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, { x: _x, y: _y } = _action$payload$coord, otherCoordinateProps = _objectWithoutProperties$15(_action$payload$coord, _excluded$15);
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), { x: propsX, y: propsY, lineHeight, capHeight, fill, scaleToFit, textAnchor, verticalAnchor } = _resolveDefaultProps, props = _objectWithoutProperties$14(_resolveDefaultProps, _excluded$14);
	...
	var { dx, dy, angle, className, breakAll } = props, textProps = _objectWithoutProperties$14(props, _excluded2$7);
...
var _excluded$13 = ["labelRef"], _excluded2$6 = ["content"];
...
function Label(outerProps) {
	...
	if (/*#__PURE__*/ (0, import_react.isValidElement)(content)) {
		...
		return /*#__PURE__*/ (0, import_react.cloneElement)(content, _objectWithoutProperties$13(propsWithViewBox, _excluded$13));
	}
	if (typeof content === "function") {
		var { content: _2 } = propsWithViewBox;
		label = /*#__PURE__*/ (0, import_react.createElement)(content, _objectWithoutProperties$13(propsWithViewBox, _excluded2$6));
...
function LabelList(_ref) {
	var { valueAccessor = defaultAccessor } = _ref, restProps = _objectWithoutProperties$12(_ref, _excluded$12);
	var { dataKey, clockWise, id, textBreakAll, zIndex } = restProps, others = _objectWithoutProperties$12(restProps, _excluded2$5);
...
var Trapezoid = (outsideProps) => {
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("g", null, /*#__PURE__*/ import_react.createElement("path", _extends$11({}, svgPropertiesAndEvents(trapezoidProps), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		return /*#__PURE__*/ import_react.createElement("path", _extends$11({}, svgPropertiesAndEvents(trapezoidProps), {
			className: layerClass,
			d: getTrapezoidPath(currX, currY, currUpperWidth, currLowerWidth, currHeight),
			ref: pathRef,
			style: _objectSpread$13(_objectSpread$13({}, animationStyle), trapezoidProps.style)
		}));
	});
};
//#endregion
...
function Shape(_ref2) {
	var { option, shapeType, activeClassName = "recharts-active-shape", inActiveClassName = "recharts-shape" } = _ref2, props = _objectWithoutProperties$11(_ref2, _excluded$11);
	var shape;
...
function DotItem(_ref) {
	...
	var _ref2 = dotProps !== null && dotProps !== void 0 ? dotProps : {}, { points } = _ref2, props = _objectWithoutProperties$10(_ref2, _excluded$10);
	return /*#__PURE__*/ import_react.createElement(Dot, _extends$10({}, props, { className: finalClassName }));
}
...
function Dots(_ref3) {
	...
	var dots = points.map((entry, i) => {
		...
		var dotProps = _objectSpread$11(_objectSpread$11(_objectSpread$11({ r: 3 }, baseProps), customDotProps), {}, {
			index: i,
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex }, /*#__PURE__*/ import_react.createElement(Layer, _extends$10({ className }, layerProps), dots));
}
//#endregion
	...
	reducers: {
		...
		updateYAxisWidth(state, action) {
			...
			if (axis) {
				...
				state.yAxis[id] = _objectSpread$10(_objectSpread$10({}, axis), {}, {
					width,
...
var _excluded$8 = [
	...
	"y2",
	"key"
], _excluded2$4 = ["offset"], _excluded3$2 = ["xAxisId", "yAxisId"], _excluded4$1 = ["xAxisId", "yAxisId"];
...
function HorizontalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$8(props, _excluded3$2);
...
var _excluded$6 = ["id"], _excluded2$3 = [
	"activeDot",
	"animationBegin",
	"animationDuration",
	"animationEasing",
...
function StaticArea(_ref4) {
	...
	var { id } = props, propsWithoutId = _objectWithoutProperties$6(props, _excluded$6);
	var allOtherProps = svgPropertiesNoEvents(propsWithoutId);
	var propsWithEvents = svgPropertiesAndEvents(propsWithoutId);
	return /*#__PURE__*/ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /*#__PURE__*/ import_react.createElement(Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0 }, /*#__PURE__*/ import_react.createElement(Curve, _extends$7({}, propsWithEvents, {
		id,
		points,
		connectNulls,
		type,
	...
	})), stroke !== "none" && /*#__PURE__*/ import_react.createElement(Curve, _extends$7({}, allOtherProps, {
		...
		fill: "none",
		points
	})), stroke !== "none" && isRange && Array.isArray(baseLine) && /*#__PURE__*/ import_react.createElement(Curve, _extends$7({}, allOtherProps, {
		className: "recharts-area-curve",
		layout,
		type,
		connectNulls,
...
function AreaImpl(props) {
	var _useAppSelector;
	var { activeDot, animationBegin, animationDuration, animationEasing, connectNulls, dot, fill, fillOpacity, hide, isAnimationActive, legendType, stroke, xAxisId, yAxisId } = props, everythingElse = _objectWithoutProperties$6(props, _excluded2$3);
	var layout = useChartLayout();
	var chartName = useChartName();
...
var BarStackClipLayer = (_ref) => {
	var { index } = _ref, rest = _objectWithoutProperties$5(_ref, _excluded$5);
...
function BarBackground(props) {
	...
	var { onMouseEnter: onMouseEnterFromProps, onMouseLeave: onMouseLeaveFromProps, onClick: onItemClickFromProps } = allOtherBarProps, restOfAllOtherProps = _objectWithoutProperties$4(allOtherBarProps, _excluded$4);
	...
	return /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex: getZIndexFromUnknown(backgroundFromProps, DefaultZIndexes.barBackground) }, data.map((entry, i) => {
		var { value, background: backgroundFromDataEntry, tooltipPosition } = entry, rest = _objectWithoutProperties$4(entry, _excluded2$2);
		...
		return /*#__PURE__*/ import_react.createElement(BarRectangle, _extends$4({ key: "background-bar-".concat(i) }, barRectangleProps));
	}));
}
...
function BarRectangleWithActiveState(props) {
	...
	var content = /*#__PURE__*/ import_react.createElement(BarRectangle, _extends$4({}, baseProps, { name: String(baseProps.name) }, entry, {
...
function BarRectangleNeverActive(props) {
	...
	return /*#__PURE__*/ import_react.createElement(BarRectangle, _extends$4({}, baseProps, { name: String(baseProps.name) }, entry, {
		isActive: false,
		option: shape,
		index,
		dataKey
...
function BarRectangles(_ref3) {
	...
	var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, { id } = _ref4, baseProps = _objectWithoutProperties$4(_ref4, _excluded3$1);
	var { shape, dataKey, activeBar } = props;
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = props, restOfAllOtherProps = _objectWithoutProperties$4(props, _excluded4);
	...
	return /*#__PURE__*/ import_react.createElement(import_react.Fragment, null, data.map((entry, i) => {
		return /*#__PURE__*/ import_react.createElement(BarStackClipLayer, _extends$4({
...
function RectanglesWithAnimation(_ref5) {
	...
	return /*#__PURE__*/ import_react.createElement(BarLabelListProvider, {
		...
		var stepData = t === 1 ? data : data === null || data === void 0 ? void 0 : data.map((entry, index) => {
			...
			if (prev) return _objectSpread$3(_objectSpread$3({}, entry), {}, {
				x: interpolate(prev.x, entry.x, t),
				y: interpolate(prev.y, entry.y, t),
...
function BarImpl(props) {
	...
	return /*#__PURE__*/ import_react.createElement(SetErrorBarContext, {
		...
		errorBarOffset
	}, /*#__PURE__*/ import_react.createElement(BarWithState, _extends$4({}, props, {
		layout,
		needClip,
		data: rects,
		xAxisId,
...
function BarFn(outsideProps) {
	...
	}), /*#__PURE__*/ import_react.createElement(ZIndexLayer, { zIndex: props.zIndex }, /*#__PURE__*/ import_react.createElement(BarImpl, _extends$4({}, props, { id })))));
}
/**
...
//#endregion
export { Area as a, ResponsiveContainer as c, Bar as i, BarChart as n, CartesianGrid as o, XAxis as r, Tooltip as s, AreaChart as t };
